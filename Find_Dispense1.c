...
//        else if(state == 4){//aim shooter
//            if (ADC1BUF9 >= vThresh && currentGoal =! desiredGoal){//if the front sensor is active and we are aimed somewhere wrong
//                desiredGoal = 0;//set desiredGoal to front goal
//                desiredSteps = 50;
//                if(currentGoal = 1){//if we are currently aiming at the left goal
//                    _LATA1 = 0;
//                }
