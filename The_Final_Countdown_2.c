...
//                        _LATA0 = 1; // START DC MOTORS
            ...
            // AIM AND SHOOT
            if (ADC1BUF9 >= vThresh2*1.2 && OC2count == 0 && substate == 1 && state == 3){//if front goal is active, and we are currently aimed at left goal
                OC3R = servo_closed;
                _OC2IE = 1;
                _LATA1 = 1;
                desiredSteps_aim = 50;
            ...
            else if (ADC1BUF9 >= vThresh2*1.2 && OC2count == 0 && substate == 2 && state == 3){//if front goal is active and we are currently aimed at right goal
                OC3R = servo_closed;
                _LATA1 = 0;
                desiredSteps_aim = 50;
                OC2R = 1600;
            ...
            else if (ADC1BUF14 >= vThresh2 && OC2count == 0 && (substate == 0 || substate == -1) && state == 3){//if right goal is active and we are currently aimed at front goal
                OC3R = servo_closed;
                _LATA1 = 0;
                desiredSteps_aim = 50;
                OC2R = 1600;
            ...
            else if (ADC1BUF14 >= vThresh2 && OC2count == 0 && substate == 2 && state == 3){
                OC3R = servo_closed;
                _LATA1 = 0;
            ...
            else if (ADC1BUF13 >= vThresh2 && OC2count == 0 && (substate == 0 || substate == -1) && state == 3){
                OC3R = servo_closed;
            ...
            else if (ADC1BUF13 >= vThresh2 && OC2count == 0 && substate == 1 && state == 3){
                OC3R = servo_closed;
            ...
            else if (ADC1BUF9 >= vThresh2 && substate == -1 && state == 3){
